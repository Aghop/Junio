...
var cita_controller_1 = __importDefault(require("./cita.controller"));
var router = express_1.default.Router();
router.get('/:id/all', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, citas, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, cita_controller_1.default.getCita(id)];
            case 2:
                citas = _a.sent();
                res.send(citas);
                return [3 /*break*/, 4];
...
router.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, cita_controller_1.default.getCitaById(id)];
            case 2:
                cita = _a.sent();
                res.send(cita);
                return [3 /*break*/, 4];
...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, cita_controller_1.default.addCita(cita)];
            case 2:
                newCita = _a.sent();
                res.send(newCita);
                return [3 /*break*/, 4];
