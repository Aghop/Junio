    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connection = _a.sent();
                    return [4 /*yield*/, connection.query("SELECT * FROM cita WHERE idcita=?", id)];
                case 2:
                    row = _a.sent();
                    return [2 /*return*/, row];
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connection = _a.sent();
                    return [4 /*yield*/, connection.query("INSERT INTO `cita` (`fechaHora`,`descripcion`,`idPaciente`,`idMedico`,`idEstado`) VALUES ('" + cita.fechaHora + "','" + cita.descripcion + "','" + cita.idPaciente + "','" + cita.idMedico + "','" + cita.idEstado + "');")];
                case 2:
                    row = _a.sent();
                    return [2 /*return*/, row];
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connection = _a.sent();
                    return [4 /*yield*/, connection.query("DELETE FROM cita WHERE idcita=?", id)];
                case 2:
                    row = _a.sent();
                    return [2 /*return*/, row];
            }
